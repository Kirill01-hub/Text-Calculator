...
print("Добро пожаловать в текстовый калькулятор. Вводите выражение, а я посчитаю и дам вам ответ в виде текста!(Результат в текстовом виде выводится для результатов до 1000. Результаты больше 1000 будут выводиться в численном виде)")
while True:
